...
CREATE INDEX IF NOT EXISTS ix_scene_image_logical_billing ON video_render.scene_image_versions(billing_logical_request_id);
CREATE INDEX IF NOT EXISTS ix_scene_video_history ON video_render.scene_video_versions(scene_id,version_number DESC);
CREATE INDEX IF NOT EXISTS ix_scene_video_logical_billing ON video_render.scene_video_versions(billing_logical_request_id);
