            ...
            || TryReadArray(item, "options", out prices))
        {
            foreach (var price in prices)
            {
                ...
                model.Prices.Add(new AiModelPriceDto
                {
                    ...
                    ProviderPriceUnit = ReadString(price, "provider_price_unit") ?? ReadString(price, "price_unit") ?? model.ProviderPriceUnit,
