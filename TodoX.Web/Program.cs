...
builder.Services.Configure<ServicePromptAssistantOptions>(
    builder.Configuration.GetSection(ServicePromptAssistantOptions.SectionName));
builder.Services.AddScoped<ServicePromptAssistantRepository>();
builder.Services.AddScoped<ServicePromptCompiler>();
